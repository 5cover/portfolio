...
<article id="encapsulation">
    ...
    <div>
        ...
        <p>For instance, <a class="link" href="/portfolio/en/project/cori"><abbr title="Correct Input">Cori</abbr></a> uses the prefix `_cori_` on internal macros, functions, structures, type aliases, and so on.</p>
