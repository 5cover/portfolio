...
<article>
<h3>`infinite_money.py`: compute an optimal game strategy from the <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Comma-separated_values" data-definition-id="csv" class="link definition-tooltip-trigger">CSV</a> game logs</h3>
