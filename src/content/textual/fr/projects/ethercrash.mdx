...
<article>
    <h3>`infinite_money.py`&nbsp;: calcule une stratégie de jeu optimale à partir des journaux de jeu <a target="_blank" rel="noopener noreferrer" href="https://fr.wikipedia.org/wiki/Comma-separated_values" data-definition-id="csv" class="link definition-tooltip-trigger">CSV</a></h3>
