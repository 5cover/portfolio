...
<article id="encapsulation">
    ...
    <div>
        ...
        <p>Par exemple, <a class="link" href="/portfolio/fr/project/cori.html"><abbr title="Correct Input">Cori</abbr></a> utilise le préfixe `_cori_` pour les fonctions, macros, structures, alias de type, etc. internes.</p>
