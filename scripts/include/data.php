...
abstract class Details extends Data
{
    ...
    abstract public function put_page_main();
    abstract public function put_card(int $headingLevel = Details::DEFAULT_CARD_HEADING_LEVEL);
...
final class Passion extends Details
{
    ...
    public function put_card(int $headingLevel = Details::DEFAULT_CARD_HEADING_LEVEL)
    {
        ?>
     ...
     * @return void
     */
    public static function put_card_list(iterable $passions)
    {
        ?>
...
final class Perspective extends Details
{
     ...
     * @return void
     */
    public static function put_card_list(iterable $perspectives)
    {
        ?>
        <ul class="lvl list-detail-split-card">
            <?php
...
final class Project extends Details
{
     ...
     * @return void
     */
    public static function put_card_list(iterable $projects, int $headingLevel = Details::DEFAULT_CARD_HEADING_LEVEL)
    {
        ?>
