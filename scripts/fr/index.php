    ...
    <main>
        ...
        <section id="ongoing-projects">
            ...
            <ul class="list-projects">
                <li style="--bg-img: url(/portfolio/img/project/winclean/bg.png)">
                    <ul class="list-tags">
                        <li><a href="projects.html?tag=software">Logiciel</a></li>
                        <li>
                            <a href="projects.html?tag=oop"><abbr title="Programmation Orientée Objet">POO</abbr></a>
                        </li>
                        <li>
                            <a href="projects.html?tag=ux"><abbr title="User Experience">UX</abbr></a>
                        </li>
                    </ul>
                    <img class="logo" src="/portfolio/img/project/winclean/logo.png" alt="Logo" width="82" height="133"
                        loading="lazy">
                    <h3><a href="project/winclean.html">WinClean</a></h3>
                    <p class="status"><small>En cours depuis août 2021 &mdash; personnel</small></p>
                    <p class="abstract">Utilitaire de nettoyage et optimisation <a>Windows</a>.</p>
                    <ul class="list-anchors">
                        <li>
                            <a href="https://github.com/5cover/WinClean" title="Dépôt GitHub">
                                <svg class="themed-fill" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    viewBox="0 0 24 24">
                                    <path
        ...
        <article class="content-block" id="contact">
            <div>
                <h2>Contact</h2>
                <ul>
                    <li title="E-mail"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" style="fill: var(--color-fg)">
                            <path
                                d="M12 12.713l-11.985-9.713h23.971l-11.986 9.713zm-5.425-1.822l-6.575-5.329v12.501l6.575-7.172zm10.85 0l6.575 7.172v-12.501l-6.575 5.329zm-1.557 1.261l-3.868 3.135-3.868-3.135-8.11 8.848h23.956l-8.11-8.848z" />
                        </svg><a class="link" href="mailto:bardini.raphael@gmail.com">bardini.raphael@gmail.com</a></li>
                    <li title="LinkedIn"><svg width="24" height="24" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" style="fill: var(--color-fg)">
                            <path
                                d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                        </svg><a class="link" href="https://www.linkedin.com/in/rapha%C3%ABl-bardini-6238432b6/">Raphaël
                            Bardini</a>
                    </li>
                    <li title="Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" style="fill: var(--color-fg)">
                            <path
                        ...
                        </svg><a class="link" href="https://www.instagram.com/bardiniraphael/">bardiniraphael</a></li>
                    <li title="GitHub"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" style="fill: var(--color-fg)">
                            <path
                                d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                        </svg><a class="link" href="https://github.com/5cover">5cover</a>
                    </li>
                </ul>
            </div>
