...
<header>
    ...
    <ul class="list-flags">
        <li><a class="fi fi-us gray-when-not-hover" title="Anglais / English"
                href="/portfolio/en/<?php echo THIS_PAGE_NAME; ?>.html"></a></li>
        <li><a class="fi fi-fr" title="Français" href="#"></a></li>
    </ul>
    <div class="theme-switches">
        <label for="theme-switch-light" title="Thème clair">
        ...
        <label for="theme-switch-system" title="Thème système">
        ...
        <label for="theme-switch-dark" title="Thème sombre">
